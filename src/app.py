...
def get_sql_chain(db):
    ...
    Write only the SQL query and nothing else. Do NOT include backticks, markdown formatting, explanations, or any additional text.
    ...
    return (
        ...
        | (lambda sql: sql.replace("```sql", "").replace("```", "").strip())
...
st.set_page_config(page_title="Ask MySQL", page_icon=":speech_balloon:")
st.title("Ask MySQL")
